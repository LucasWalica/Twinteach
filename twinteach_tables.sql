create table alumno(
    ...
    ICONO VARCHAR(2083) UNIQUE DEFAULT 'urlejemplo' /* valor de URL que dirija al icono, por defecto una URL de icono por defecto. digo yo*/
)
...
CREATE TABLE PROFESOR(
    ...
    ICONO ICONO VARCHAR(2083) UNIQUE DEFAULT 'urlejemplo'
),
...
CREATE TABLE COFRE(
    ...
    --esto igual deberia ser posible que sea null porque se implementaria en otro lenguaje los valores
)
-- (FLOOR(RAND() * 20) + 1); (NUMERO RANDOM DE 1 A 20) EJEMPLO

--relacion con un regalo entre medias->
CREATE TABLE PROF_PUNTUAR(
    ID_PUNTUAJE INT PRIMARY KEY,
    ID_PROFESOR INT,
    ID_ALUMNO_CLASE INT, 
    ID_COFRE INT,
    Nota FLOAT(2),
