...
CREATE TABLE NOTIFICACIONES(
    ...
    INVASION_ref INT FOREIGN key(INVASION_ref)
    ATAQUE_ref INT FOREIGN key(ATAQUE_ref)
    PUNTUA_ref INT FOREIGN key(PUNTUA_ref)
    PROF_PUNTUA_ref INT FOREIGN key(PROF_PUNTUA_ref)
