...
CREATE TABLE PUNTUAR(
    ...
    ID_ATACANTE INT FOREIGN KEY(ID_ATACANTE) REFERENCES ALUMNO_CLASE(ID_ALUMNO_CLASE),  
    ID_DEFENSOR INT FOREIGN KEY(ID_ATACANTE) REFERENCES ALUMNO_CLASE(ID_ALUMNO_CLASE),
    SOFTSKILL VARCHAR(12) NOT NULL 
    CHECK(SOFTSKILL="Responsabilidad" or SOFTSKILL="Cooperacion" or SOFTSKILL="Autonomia_e_iniciativa" or SOFTSKILL="Gestion_emocional" or SOFTSKILL="Habilidad_de_pensamiento"),
